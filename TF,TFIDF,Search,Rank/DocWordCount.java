...
// Author : Vinayaka Narayan
// Email : vnaraya5@uncc.edu
// Student ID : 800911516
...
public class DocWordCount extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new DocWordCount(), args); // getting the instance of the class and initializing the run function
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		Job job = Job.getInstance(getConf(), " docwordcount "); // creating the job to hadoop
		...
		job.setOutputValueClass(IntWritable.class); // The Key-Value pair - The value part of it is being defined up here as IntWritable
